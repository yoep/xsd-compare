...
import com.compare.xsd.ui.exceptions.PrimaryWindowAlreadyPresentException;
...
public class ViewManagerImpl implements ViewManager {
    ...
    private void exitApplication() {
        Platform.exit();
        ((ConfigurableApplicationContext) XsdCompareApplication.APPLICATION_CONTEXT).close();
        System.exit(0);
    }
